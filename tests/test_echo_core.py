...
class TestEchoesAssistantV2:
    ...
    @patch('atmosphere_audio.echo.core.core.load_dotenv')
    @patch('atmosphere_audio.echo.core.core.OpenAI')
    ...
    @patch('atmosphere_audio.echo.core.core.AgentWorkflow')
    @patch('atmosphere_audio.echo.core.core.QuantumStateManager')
    @patch('atmosphere_audio.echo.core.core.KnowledgeGraph')
    @patch('atmosphere_audio.echo.core.core.EnhancedStatusIndicator')
    @patch('atmosphere_audio.echo.core.core.InventoryService')
    def test_rag_context_retrieval_with_results(self, mock_inventory, mock_status, mock_knowledge_graph,
                                               mock_quantum, mock_agent, mock_fs, mock_knowledge,
                                               mock_memory, mock_context, mock_openai, mock_load_dotenv):
    ...
    @patch('atmosphere_audio.echo.core.core.load_dotenv')
    @patch('atmosphere_audio.echo.core.core.OpenAI')
    @patch('atmosphere_audio.echo.core.core.ContextManager')
    @patch('atmosphere_audio.echo.core.core.MemoryStore')
    @patch('atmosphere_audio.echo.core.core.KnowledgeManager')
    @patch('atmosphere_audio.echo.core.core.FilesystemTools')
    @patch('atmosphere_audio.echo.core.core.AgentWorkflow')
    @patch('atmosphere_audio.echo.core.core.QuantumStateManager')
    @patch('atmosphere_audio.echo.core.core.KnowledgeGraph')
    @patch('atmosphere_audio.echo.core.core.EnhancedStatusIndicator')
    @patch('atmosphere_audio.echo.core.core.InventoryService')
    def test_rag_context_retrieval_error(self, mock_inventory, mock_status, mock_knowledge_graph,
                                        mock_quantum, mock_agent, mock_fs, mock_knowledge,
                                        mock_memory, mock_context, mock_openai, mock_load_dotenv):
